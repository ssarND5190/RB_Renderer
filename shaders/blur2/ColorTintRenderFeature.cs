...
public class ColorTintRenderFeature : ScriptableRendererFeature
{
    ...
    public override void Create() //新建pass
    {
        ...
        colorTintPass = new ColorTintPass(RenderPassEvent.BeforeRenderingPostProcessing, Shader.Find("PostProcess/ColorTint")); //初始化，上面那个东西的shader
    }
    ...
    {
        colorTintPass.Setup(renderer.cameraColorTargetHandle, renderer.cameraDepthTargetHandle);  // use of target after allocation
    }
}
...
public class ColorTintPass : ScriptableRenderPass
{
    ...
    static readonly int DepthTexId = Shader.PropertyToID("_DepthTex");
    ...
    //【初始化】
    #region Initialize
    public void Setup(in RenderTargetIdentifier currentTarget, in RenderTargetIdentifier depthTarget)
    {
...
//    【这一坨是DualKawase渲染】
    ...
    void Render(CommandBuffer cmd, ref RenderingData renderingData)
    {
        ...
        cmd.SetGlobalTexture(DepthTexId, depthSource);
